...
{
    [Description("Creates a sequence of Bulirsch Stoer rational interpolation objects based on arbitrary points.")]
    public class CreateRationalWithPoles : InterpolationBase
    {
